...
from da_rnn import read_data, DA_RNN
...
def main():
    ...
    lr = 0.001
    epochs = 50
    dataroot = '../../data/raw/nasdaq100_padding.csv'
    ...
    model = DA_RNN(X, y, T, T_predict, nhidden_encoder, nhidden_decoder, batchsize, lr, epochs)
